...
FOUNDATION_EXPORT JavaxCryptoextObjectInputStream *new_JavaxCryptoextObjectInputStream_initWithJavaIoInputStream_(JavaIoInputStream *inArg) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaxCryptoextObjectInputStream *create_JavaxCryptoextObjectInputStream_initWithJavaIoInputStream_(JavaIoInputStream *inArg);
