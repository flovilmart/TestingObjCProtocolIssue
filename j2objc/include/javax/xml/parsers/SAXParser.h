...
/*!
 ...
 <code>javax.xml.parsers.SAXParserFactory</code> method.
...
/*!
 ...
 <p>The reset <code>SAXParser</code> is not guaranteed to have the same <code>Schema</code>
  <code>Object</code>, e.g. <code>obj)</code>.  It is guaranteed to have a functionally equal 
 <code>Schema</code>.</p>
 @since 1.5
 */
- (void)reset;
...
/*!
 ...
 Use <code>javax.xml.parsers.SAXParserFactory</code>.</p>
 */
- (instancetype)init;
