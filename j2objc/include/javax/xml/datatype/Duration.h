...
/*!
 ...
 <p>For example, 30 days cannot be meaningfully compared to one month.
  The <code>duration)</code> method implements this
  relationship.</p>
...
/*!
 ...
 <p>
  Calls <code>java.util.Calendar</code> in the
 ...
 <p>
  Note that because <code>int)</code> is using 
...
/*!
 ...
 Type is computed based on fields that are set,
  i.e. <code>field)</code> == <code>true</code>.</p>
...
/*!
 ...
 <p>The result is formatted according to the XML Schema 1.0 specification and can be always parsed back later into the
  equivalent <code>Duration</code> <code>Object</code> by <code>lexicalRepresentation)</code>.</p>
