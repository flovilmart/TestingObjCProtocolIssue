...
/*!
 ...
 <p>
  Note that while the <code>validate(javax.xml.transform.Source)</code> and <code>javax.xml.transform.Result)</code>
...
/*!
 ...
 <p>
  ...
  (see <code>javax.xml.transform.TransformerFactory</code>).
