...
FOUNDATION_EXPORT JavaxXmlTransformStreamFilePathToURI *new_JavaxXmlTransformStreamFilePathToURI_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaxXmlTransformStreamFilePathToURI *create_JavaxXmlTransformStreamFilePathToURI_init(void);
