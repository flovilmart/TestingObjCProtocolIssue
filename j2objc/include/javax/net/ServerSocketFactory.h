...
FOUNDATION_EXPORT JavaxNetDefaultServerSocketFactory *new_JavaxNetDefaultServerSocketFactory_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaxNetDefaultServerSocketFactory *create_JavaxNetDefaultServerSocketFactory_init(void);
