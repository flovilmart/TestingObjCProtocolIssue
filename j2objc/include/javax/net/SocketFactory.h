...
FOUNDATION_EXPORT JavaxNetDefaultSocketFactory *new_JavaxNetDefaultSocketFactory_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaxNetDefaultSocketFactory *create_JavaxNetDefaultSocketFactory_init(void);
