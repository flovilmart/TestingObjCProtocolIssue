...
/*!
 ...
 <code>SSLEngine</code> user to arrange for reliable I/O transport to
  ...
  wide variety of I/O types, such as <code>I/O (polling)</code>
 , <code>non-blocking I/O</code>
...
@endcode
 ...
 <P>
  For example, <code>unwrap()</code> will return a <code>SSLEngineResult.Status</code>
  ...
  were to return a <code>SSLEngineResult.Status</code>, the
...
/*!
 ...
 <P>
  ...
  been closed, this method does not do anything. 
 <P>
  <code>ByteBuffer)</code> should be
  called to flush any remaining handshake data.
 - seealso: #isOutboundDone()
 */
- (void)closeOutbound;
...
/*!
 @brief Returns whether <code>ByteBuffer)</code> will
...
<P>
 ...
 <blockquote>@code
  ...
  <code>new ByteBuffer [] { dst }, 0, 1);</code>
   </pre</blockquote>
@param src a 
...
/*!
 ...
 <code>java.nio.channels.ScatteringByteChannel</code> for more
  information on scattering, and <code>java.nio.channels.ScatteringByteChannel</code>
...
<P>
 ...
 <blockquote>@code
  ...
  <code>ByteBuffer [] { src }, 0, 1, dst);</code>
   </pre</blockquote>
@param src a 
...
/*!
 ...
 <code>java.nio.channels.GatheringByteChannel</code> for more
  information on gathering, and <code>java.nio.channels.GatheringByteChannel</code>
  for more information on the subsequence
  behavior. 
 <P>
