...
- (AndroidUtilSparseBooleanArray *)java_clone;
...
FOUNDATION_EXPORT AndroidUtilSparseBooleanArray *new_AndroidUtilSparseBooleanArray_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT AndroidUtilSparseBooleanArray *create_AndroidUtilSparseBooleanArray_init(void);
