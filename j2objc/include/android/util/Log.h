...
/*!
 ...
 Similar to <code>Throwable)</code>, with a message as well.
 @param tag Used to identify the source of a log message.
 @param msg The message you would like logged.
...
/*!
 @brief What a Terrible Failure: Report an exception that should never happen.
 Similar to <code>String)</code>, with an exception to log.
 @param tag Used to identify the source of a log message.
 @param tr An exception to log.
 */
+ (jint)wtfWithNSString:(NSString *)tag
...
/*!
 @brief Like <code>String)</code>, but also writes to the log the full
  call stack.
 */
