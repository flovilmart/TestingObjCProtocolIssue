...
/*!
 @brief SparseIntArrays map integers to integers.Unlike a normal array of integers,
...
- (AndroidUtilSparseIntArray *)java_clone;
...
FOUNDATION_EXPORT AndroidUtilSparseIntArray *new_AndroidUtilSparseIntArray_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT AndroidUtilSparseIntArray *create_AndroidUtilSparseIntArray_init(void);
