...
FOUNDATION_EXPORT ComGoogleCommonCacheLongAdder *new_ComGoogleCommonCacheLongAdder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCacheLongAdder *create_ComGoogleCommonCacheLongAdder_init(void);
