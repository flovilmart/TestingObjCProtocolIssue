...
FOUNDATION_EXPORT id<ComGoogleCommonCacheLocalCache_ReferenceEntry> ComGoogleCommonCacheLocalCache_nullEntry(void);
...
- (instancetype)initWithJavaLangRefReferenceQueue:(JavaLangRefReferenceQueue *)arg0
                                           withId:(id)arg1
withComGoogleCommonCacheLocalCache_ReferenceEntry:(id<ComGoogleCommonCacheLocalCache_ReferenceEntry>)arg2 NS_UNAVAILABLE;
