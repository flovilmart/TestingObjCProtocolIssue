...
FOUNDATION_EXPORT ComGoogleCommonCacheCacheBuilder *new_ComGoogleCommonCacheCacheBuilder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCacheCacheBuilder *create_ComGoogleCommonCacheCacheBuilder_init(void);
