...
@interface ComGoogleCommonCollectGenericMapMaker_NullListener : JavaLangEnum < ComGoogleCommonCollectMapMaker_RemovalListener >
...
inline ComGoogleCommonCollectGenericMapMaker_NullListener *ComGoogleCommonCollectGenericMapMaker_NullListener_get_INSTANCE(void);
J2OBJC_ENUM_CONSTANT(ComGoogleCommonCollectGenericMapMaker_NullListener, INSTANCE)

FOUNDATION_EXPORT IOSObjectArray *ComGoogleCommonCollectGenericMapMaker_NullListener_values(void);
