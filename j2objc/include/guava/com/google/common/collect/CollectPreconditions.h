...
FOUNDATION_EXPORT ComGoogleCommonCollectCollectPreconditions *new_ComGoogleCommonCollectCollectPreconditions_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleCommonCollectCollectPreconditions *create_ComGoogleCommonCollectCollectPreconditions_init(void);
