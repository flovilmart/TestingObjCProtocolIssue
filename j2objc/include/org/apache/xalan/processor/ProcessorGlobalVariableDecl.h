...
FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorGlobalVariableDecl *new_OrgApacheXalanProcessorProcessorGlobalVariableDecl_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorGlobalVariableDecl *create_OrgApacheXalanProcessorProcessorGlobalVariableDecl_init(void);
