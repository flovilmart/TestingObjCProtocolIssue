...
FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorTemplate *new_OrgApacheXalanProcessorProcessorTemplate_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorTemplate *create_OrgApacheXalanProcessorProcessorTemplate_init(void);
