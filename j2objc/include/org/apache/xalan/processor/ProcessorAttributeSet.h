...
FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorAttributeSet *new_OrgApacheXalanProcessorProcessorAttributeSet_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorAttributeSet *create_OrgApacheXalanProcessorProcessorAttributeSet_init(void);
