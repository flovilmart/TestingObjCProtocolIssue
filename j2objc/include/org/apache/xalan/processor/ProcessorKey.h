...
FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorKey *new_OrgApacheXalanProcessorProcessorKey_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorKey *create_OrgApacheXalanProcessorProcessorKey_init(void);
