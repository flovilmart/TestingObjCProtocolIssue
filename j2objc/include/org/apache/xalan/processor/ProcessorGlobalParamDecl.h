...
FOUNDATION_EXPORT void OrgApacheXalanProcessorProcessorGlobalParamDecl_init(OrgApacheXalanProcessorProcessorGlobalParamDecl *self);

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorGlobalParamDecl *new_OrgApacheXalanProcessorProcessorGlobalParamDecl_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorGlobalParamDecl *create_OrgApacheXalanProcessorProcessorGlobalParamDecl_init(void);
