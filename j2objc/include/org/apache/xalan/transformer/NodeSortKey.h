...
FOUNDATION_EXPORT void OrgApacheXalanTransformerNodeSortKey_initWithOrgApacheXalanTransformerTransformerImpl_withOrgApacheXpathXPath_withBoolean_withBoolean_withNSString_withBoolean_withOrgApacheXmlUtilsPrefixResolver_(OrgApacheXalanTransformerNodeSortKey *self, OrgApacheXalanTransformerTransformerImpl *transformer, OrgApacheXpathXPath *selectPat, jboolean treatAsNumbers, jboolean descending, NSString *langValue, jboolean caseOrderUpper, id<OrgApacheXmlUtilsPrefixResolver> namespaceContext);

FOUNDATION_EXPORT OrgApacheXalanTransformerNodeSortKey *new_OrgApacheXalanTransformerNodeSortKey_initWithOrgApacheXalanTransformerTransformerImpl_withOrgApacheXpathXPath_withBoolean_withBoolean_withNSString_withBoolean_withOrgApacheXmlUtilsPrefixResolver_(OrgApacheXalanTransformerTransformerImpl *transformer, OrgApacheXpathXPath *selectPat, jboolean treatAsNumbers, jboolean descending, NSString *langValue, jboolean caseOrderUpper, id<OrgApacheXmlUtilsPrefixResolver> namespaceContext) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanTransformerNodeSortKey *create_OrgApacheXalanTransformerNodeSortKey_initWithOrgApacheXalanTransformerTransformerImpl_withOrgApacheXpathXPath_withBoolean_withBoolean_withNSString_withBoolean_withOrgApacheXmlUtilsPrefixResolver_(OrgApacheXalanTransformerTransformerImpl *transformer, OrgApacheXpathXPath *selectPat, jboolean treatAsNumbers, jboolean descending, NSString *langValue, jboolean caseOrderUpper, id<OrgApacheXmlUtilsPrefixResolver> namespaceContext);
