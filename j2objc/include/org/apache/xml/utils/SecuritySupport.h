...
FOUNDATION_EXPORT OrgApacheXmlUtilsSecuritySupport *new_OrgApacheXmlUtilsSecuritySupport_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsSecuritySupport *create_OrgApacheXmlUtilsSecuritySupport_init(void);
