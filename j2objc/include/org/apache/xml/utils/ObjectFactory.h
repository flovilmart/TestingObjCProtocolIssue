...
FOUNDATION_EXPORT OrgApacheXmlUtilsObjectFactory *new_OrgApacheXmlUtilsObjectFactory_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsObjectFactory *create_OrgApacheXmlUtilsObjectFactory_init(void);
