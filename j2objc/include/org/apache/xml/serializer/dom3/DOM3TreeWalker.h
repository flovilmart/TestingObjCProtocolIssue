 ...
 */
- (instancetype)initWithOrgApacheXmlSerializerSerializationHandler:(id<OrgApacheXmlSerializerSerializationHandler>)serialHandler
...
FOUNDATION_EXPORT void OrgApacheXmlSerializerDom3DOM3TreeWalker_initWithOrgApacheXmlSerializerSerializationHandler_withOrgW3cDomDOMErrorHandler_withOrgW3cDomLsLSSerializerFilter_withNSString_(OrgApacheXmlSerializerDom3DOM3TreeWalker *self, id<OrgApacheXmlSerializerSerializationHandler> serialHandler, id<OrgW3cDomDOMErrorHandler> errHandler, id<OrgW3cDomLsLSSerializerFilter> filter, NSString *newLine);

FOUNDATION_EXPORT OrgApacheXmlSerializerDom3DOM3TreeWalker *new_OrgApacheXmlSerializerDom3DOM3TreeWalker_initWithOrgApacheXmlSerializerSerializationHandler_withOrgW3cDomDOMErrorHandler_withOrgW3cDomLsLSSerializerFilter_withNSString_(id<OrgApacheXmlSerializerSerializationHandler> serialHandler, id<OrgW3cDomDOMErrorHandler> errHandler, id<OrgW3cDomLsLSSerializerFilter> filter, NSString *newLine) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerDom3DOM3TreeWalker *create_OrgApacheXmlSerializerDom3DOM3TreeWalker_initWithOrgApacheXmlSerializerSerializationHandler_withOrgW3cDomDOMErrorHandler_withOrgW3cDomLsLSSerializerFilter_withNSString_(id<OrgApacheXmlSerializerSerializationHandler> serialHandler, id<OrgW3cDomDOMErrorHandler> errHandler, id<OrgW3cDomLsLSSerializerFilter> filter, NSString *newLine);
