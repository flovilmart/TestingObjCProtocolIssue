...
FOUNDATION_EXPORT void OrgApacheXmlSerializerWriterToASCI_initWithJavaIoOutputStream_(OrgApacheXmlSerializerWriterToASCI *self, JavaIoOutputStream *os);

FOUNDATION_EXPORT OrgApacheXmlSerializerWriterToASCI *new_OrgApacheXmlSerializerWriterToASCI_initWithJavaIoOutputStream_(JavaIoOutputStream *os) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerWriterToASCI *create_OrgApacheXmlSerializerWriterToASCI_initWithJavaIoOutputStream_(JavaIoOutputStream *os);
