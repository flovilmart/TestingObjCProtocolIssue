...
FOUNDATION_EXPORT OrgApacheXmlSerializerElemContext *new_OrgApacheXmlSerializerElemContext_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerElemContext *create_OrgApacheXmlSerializerElemContext_init(void);
