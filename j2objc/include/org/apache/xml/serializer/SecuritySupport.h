...
FOUNDATION_EXPORT OrgApacheXmlSerializerSecuritySupport *new_OrgApacheXmlSerializerSecuritySupport_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerSecuritySupport *create_OrgApacheXmlSerializerSecuritySupport_init(void);
