...
FOUNDATION_EXPORT OrgApacheXmlDtmSecuritySupport *new_OrgApacheXmlDtmSecuritySupport_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlDtmSecuritySupport *create_OrgApacheXmlDtmSecuritySupport_init(void);
