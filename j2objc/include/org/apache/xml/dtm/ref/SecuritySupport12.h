...
FOUNDATION_EXPORT OrgApacheXmlDtmRefSecuritySupport12 *new_OrgApacheXmlDtmRefSecuritySupport12_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlDtmRefSecuritySupport12 *create_OrgApacheXmlDtmRefSecuritySupport12_init(void);
