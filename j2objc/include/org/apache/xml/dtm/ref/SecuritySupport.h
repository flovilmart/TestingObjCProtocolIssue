...
FOUNDATION_EXPORT OrgApacheXmlDtmRefSecuritySupport *new_OrgApacheXmlDtmRefSecuritySupport_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlDtmRefSecuritySupport *create_OrgApacheXmlDtmRefSecuritySupport_init(void);
