...
FOUNDATION_EXPORT OrgApacheXpathFunctionsObjectFactory *new_OrgApacheXpathFunctionsObjectFactory_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathFunctionsObjectFactory *create_OrgApacheXpathFunctionsObjectFactory_init(void);
