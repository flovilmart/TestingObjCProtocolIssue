...
FOUNDATION_EXPORT OrgApacheXpathFunctionsSecuritySupport *new_OrgApacheXpathFunctionsSecuritySupport_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathFunctionsSecuritySupport *create_OrgApacheXpathFunctionsSecuritySupport_init(void);
