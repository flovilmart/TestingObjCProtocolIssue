...
FOUNDATION_EXPORT void OrgApacheXpathCompilerLexer_initWithOrgApacheXpathCompilerCompiler_withOrgApacheXmlUtilsPrefixResolver_withOrgApacheXpathCompilerXPathParser_(OrgApacheXpathCompilerLexer *self, OrgApacheXpathCompilerCompiler *compiler, id<OrgApacheXmlUtilsPrefixResolver> resolver, OrgApacheXpathCompilerXPathParser *xpathProcessor);

FOUNDATION_EXPORT OrgApacheXpathCompilerLexer *new_OrgApacheXpathCompilerLexer_initWithOrgApacheXpathCompilerCompiler_withOrgApacheXmlUtilsPrefixResolver_withOrgApacheXpathCompilerXPathParser_(OrgApacheXpathCompilerCompiler *compiler, id<OrgApacheXmlUtilsPrefixResolver> resolver, OrgApacheXpathCompilerXPathParser *xpathProcessor) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathCompilerLexer *create_OrgApacheXpathCompilerLexer_initWithOrgApacheXpathCompilerCompiler_withOrgApacheXmlUtilsPrefixResolver_withOrgApacheXpathCompilerXPathParser_(OrgApacheXpathCompilerCompiler *compiler, id<OrgApacheXmlUtilsPrefixResolver> resolver, OrgApacheXpathCompilerXPathParser *xpathProcessor);
