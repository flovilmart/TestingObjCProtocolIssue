...
/*!
 @brief Returns a <code>Statement</code>: Call <code>RunNotifier)</code>
...
/*!
 ...
 <ul>
  <li>Call <code>RunNotifier)</code> on each object returned by <code>getChildren()</code> (subject to any imposed filter and sort).</li>
