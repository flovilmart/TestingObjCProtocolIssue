...
FOUNDATION_EXPORT OrgMockitoExceptionsReporter *new_OrgMockitoExceptionsReporter_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoExceptionsReporter *create_OrgMockitoExceptionsReporter_init(void);
