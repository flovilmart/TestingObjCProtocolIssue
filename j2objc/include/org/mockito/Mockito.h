...
@endcode
 ...
 <code>here to see</code> more built-in matchers 
...
@endcode
 ...
 <b>Before the release 1.8</b>, Mockito spies were not real partial mocks. 
  ...
  (3rd party interfaces, interim refactoring of legacy code, the full article is <a href="http://monkeyisland.pl/2009/01/13/subclass-and-override-vs-partial-mocking-vs-refactoring">
 here</a>)
  <p>
...
/*!
 ...
 <p>
  Ignored stubs will also be ignored for verification inOrder, including <code>org.mockito.InOrder</code>.
...
/*!
 ...
 <p>
  <b>If you use <code>&#064;Mock</code> annotation then you've got naming mocks for free!</b> <code>&#064;Mock</code> uses field name as mock name. <code>more.</code>
  <p>
...
/*!
 @brief Allows verifying with timeout.It causes a verify to wait for a specified period of time for a desired
  interaction rather than fails immediately if had not already happened.
 May be useful for testing in concurrent
  conditions. 
 <p>
...
/*!
 @brief Helps debugging failing tests.Experimental - use at your own risk.
 We're not sure if this method will stay in public api.
 */
...
/*!
 @brief Optional <code>Answer</code> to be used with <code>Answer)</code>.
 <p>
  <code>Answer</code> can be used to define the return values of unstubbed invocations. 
 <p>
