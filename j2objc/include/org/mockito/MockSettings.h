...
/*!
 ...
 <p>
  <b>If you use &#064;Mock annotation then you've got naming mocks for free!</b> &#064;Mock uses field name as mock name. <code>more.</code>
  <p>
  Examples: 
 <pre class="code"><code class="java">
...
@endcode
  See the <code>interface</code> for more details.
