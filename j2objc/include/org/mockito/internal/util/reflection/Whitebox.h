...
FOUNDATION_EXPORT OrgMockitoInternalUtilReflectionWhitebox *new_OrgMockitoInternalUtilReflectionWhitebox_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalUtilReflectionWhitebox *create_OrgMockitoInternalUtilReflectionWhitebox_init(void);
