...
/*!
 ...
 <p>The method <code>boolean)</code> is used.</p>
 @param lhs the left hand  <code> boolean[] </code>
 @param rhs the right hand  <code> boolean[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
/*!
 ...
 <p>The method <code>byte)</code> is used.</p>
 @param lhs the left hand  <code> byte[] </code>
 @param rhs the right hand  <code> byte[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
/*!
 ...
 <p>The method <code>char)</code> is used.</p>
 @param lhs the left hand  <code> char[] </code>
 @param rhs the right hand  <code> char[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
/*!
 ...
 <p>The method <code>double)</code> is used.</p>
 @param lhs the left hand  <code> double[] </code>
 @param rhs the right hand  <code> double[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
/*!
 ...
 <p>The method <code>float)</code> is used.</p>
 @param lhs the left hand  <code> float[] </code>
 @param rhs the right hand  <code> float[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
/*!
 ...
 <p>The method <code>int)</code> is used.</p>
 @param lhs the left hand  <code> int[] </code>
 @param rhs the right hand  <code> int[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
/*!
 ...
 <p>The method <code>long)</code> is used.</p>
...
/*!
 ...
 <p>The method <code>short)</code> is used.</p>
 @param lhs the left hand  <code> short[] </code>
 @param rhs the right hand  <code> short[] </code>
 @return EqualsBuilder - used to chain calls.
 */
...
FOUNDATION_EXPORT OrgMockitoInternalMatchersApachecommonsEqualsBuilder *new_OrgMockitoInternalMatchersApachecommonsEqualsBuilder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalMatchersApachecommonsEqualsBuilder *create_OrgMockitoInternalMatchersApachecommonsEqualsBuilder_init(void);
