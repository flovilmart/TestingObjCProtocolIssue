...
FOUNDATION_EXPORT OrgMockitoInternalCreationIosIosMockMaker *new_OrgMockitoInternalCreationIosIosMockMaker_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalCreationIosIosMockMaker *create_OrgMockitoInternalCreationIosIosMockMaker_init(void);
...
FOUNDATION_EXPORT OrgMockitoInternalCreationIosIosMockMaker_ClassProxy *new_OrgMockitoInternalCreationIosIosMockMaker_ClassProxy_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalCreationIosIosMockMaker_ClassProxy *create_OrgMockitoInternalCreationIosIosMockMaker_ClassProxy_init(void);
