...
FOUNDATION_EXPORT OrgMockitoInternalInvocationInvocationsFinder *new_OrgMockitoInternalInvocationInvocationsFinder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalInvocationInvocationsFinder *create_OrgMockitoInternalInvocationInvocationsFinder_init(void);
