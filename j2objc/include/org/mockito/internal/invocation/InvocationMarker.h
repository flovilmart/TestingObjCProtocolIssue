...
FOUNDATION_EXPORT OrgMockitoInternalInvocationInvocationMarker *new_OrgMockitoInternalInvocationInvocationMarker_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalInvocationInvocationMarker *create_OrgMockitoInternalInvocationInvocationMarker_init(void);
