...
FOUNDATION_EXPORT OrgMockitoInternalInvocationFinderAllInvocationsFinder *new_OrgMockitoInternalInvocationFinderAllInvocationsFinder_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalInvocationFinderAllInvocationsFinder *create_OrgMockitoInternalInvocationFinderAllInvocationsFinder_init(void);
