...
FOUNDATION_EXPORT OrgMockitoInternalConfigurationMockitoAnnotationsMockAnnotationProcessor *new_OrgMockitoInternalConfigurationMockitoAnnotationsMockAnnotationProcessor_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgMockitoInternalConfigurationMockitoAnnotationsMockAnnotationProcessor *create_OrgMockitoInternalConfigurationMockitoAnnotationsMockAnnotationProcessor_init(void);
