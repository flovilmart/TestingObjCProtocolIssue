...
FOUNDATION_EXPORT OrgMockitoInternalConfigurationInjectionConstructorInjection *create_OrgMockitoInternalConfigurationInjectionConstructorInjection_initWithOrgMockitoInternalUtilReflectionFieldInitializer_ConstructorArgumentResolver_(id<OrgMockitoInternalUtilReflectionFieldInitializer_ConstructorArgumentResolver> argResolver);
