...
/*!
 @brief Reads a string that is encoded in <code>UTF-8</code> from
 ...
 Blocks until all
  ...
  exception is thrown.
 @return the next string encoded in <code>UTF-8</code> from
          this file.
 @throw EOFException
 if the end of this file is detected.
 @throw IOException
...
/*!
 @brief Writes a string encoded with <code>UTF-8</code> to this
  file, starting at the current file pointer.
 @param str the string to write in 
 <code>UTF-8</code>             format.
 @throw IOException
 if an I/O error occurs while writing to this file.
 @throw UTFDataFormatException
