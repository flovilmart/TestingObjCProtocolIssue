...
/*!
 ...
 <p> Double buffers can be created either by <code></code><i>allocation</i><code></code>
...
@endcode
 @return This buffer
 @throw BufferUnderflowExceptionIf there are fewer than <tt>length</tt> doubles
...
@endcode
 ...
 @param offset The offset within the array of the first double to be                written; must be non-negative and no larger than
                 
  <tt> dst.length </tt>
 @param length The maximum number of doubles to be written to the given                array; must be non-negative and no larger than
...
/*!
 ...
 <p> The byte order of a double buffer created by allocation or by
  wrapping an existing <tt>double</tt> array is the <code>order<code></code>
  of the underlying
...
@endcode
 ...
 @param offset The offset within the array of the first double to be read;                must be non-negative and no larger than 
  <tt> array.length </tt>
 @param length The number of doubles to be read from the given array;                must be non-negative and no larger than
