...
/*!
 ...
 <p> Float buffers can be created either by <code></code><i>allocation</i><code></code>
...
@endcode
 @return This buffer
 @throw BufferUnderflowExceptionIf there are fewer than <tt>length</tt> floats
...
@endcode
 ...
 @param offset The offset within the array of the first float to be                written; must be non-negative and no larger than
                 
  <tt> dst.length </tt>
 @param length The maximum number of floats to be written to the given                array; must be non-negative and no larger than
...
/*!
 ...
 <p> The byte order of a float buffer created by allocation or by
  wrapping an existing <tt>float</tt> array is the <code>order<code></code>
  of the underlying
...
@endcode
 ...
 @param offset The offset within the array of the first float to be read;                must be non-negative and no larger than 
  <tt> array.length </tt>
 @param length The number of floats to be read from the given array;                must be non-negative and no larger than
