...
/*!
 ...
 <p> Int buffers can be created either by <code></code><i>allocation</i><code></code>
...
@endcode
 @return This buffer
 @throw BufferUnderflowExceptionIf there are fewer than <tt>length</tt> ints
...
@endcode
 ...
 @param offset The offset within the array of the first int to be                written; must be non-negative and no larger than
                 
  <tt> dst.length </tt>
 @param length The maximum number of ints to be written to the given                array; must be non-negative and no larger than
...
/*!
 ...
 <p> The byte order of an int buffer created by allocation or by
  wrapping an existing <tt>int</tt> array is the <code>order<code></code>
  of the underlying
...
@endcode
 ...
 @param offset The offset within the array of the first int to be read;                must be non-negative and no larger than 
  <tt> array.length </tt>
 @param length The number of ints to be read from the given array;                must be non-negative and no larger than
...
@endcode
  ...
  buffer and it is potentially much more efficient. </p>
 @param src The source buffer from which ints are to be read;             must not be this buffer
 @return This buffer
 @throw BufferOverflowExceptionIf there is insufficient space in this buffer
