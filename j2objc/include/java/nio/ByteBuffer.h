...
/*!
 ...
 <li><p> Absolute and relative <code></code><i>get</i><code></code>
  and <code></code><i>put</i><code></code> methods that read and
 ...
 <p> Byte buffers can be created either by <code></code><i>allocation</i><code></code>
 , which allocates space for the buffer's
  content, or by <code></code><i>wrapping</i><code></code> an
 ...
 <p> A direct byte buffer may also be created by <code></code>mapping<code></code>
  a region of a file
 ...
 <blockquote>@code
  ...
  float  <code>index)</code>
   void  <code>f)</code>
   void  <code>index, float f)</code>
@endcode</blockquote>
...
/*!
 ...
 <code>array<code></code> is unspecified.
 @param capacity The new buffer's capacity, in bytes
 @return The new byte buffer
 @throw IllegalArgumentExceptionIf the <tt>capacity</tt> is a negative integer
 */
...
@endcode
 @return This buffer
 @throw BufferUnderflowExceptionIf there are fewer than <tt>length</tt> bytes
...
/*!
 ...
 @throw BufferUnderflowExceptionIf there are fewer than two bytes
                                   remaining in this buffer
 */
- (jchar)getChar;
...
/*!
 ...
 @throw BufferUnderflowExceptionIf there are fewer than eight bytes
                                   remaining in this buffer
 */
- (jdouble)getDouble;
...
/*!
 ...
 @throw BufferUnderflowExceptionIf there are fewer than four bytes
                                   remaining in this buffer
 */
- (jfloat)getFloat;
...
/*!
 ...
 @param bo The new byte order,            either 
 <code>BIG_ENDIAN</code>            or 
...
/*!
 ...
 @return This buffer
 @throw BufferOverflowExceptionIf there are fewer than two bytes
                                  remaining in this buffer
 @throw ReadOnlyBufferExceptionIf this buffer is read-only
 */
...
/*!
 ...
 @return This buffer
 @throw BufferOverflowExceptionIf there are fewer than eight bytes
                                  remaining in this buffer
 @throw ReadOnlyBufferExceptionIf this buffer is read-only
 */
...
/*!
 ...
 @return This buffer
 @throw BufferOverflowExceptionIf there are fewer than four bytes
                                  remaining in this buffer
 @throw ReadOnlyBufferExceptionIf this buffer is read-only
 */
