...
/*!
 @brief A charset is a named mapping between Unicode characters and byte sequences.Every
...
/*!
 @brief Compares this charset with the given charset.This comparison is
  based on the case insensitive canonical names of the charsets.
 @param charset the given object to be compared with.
...
/*!
 @brief Determines whether this charset is a superset of the given charset.A charset C1 contains
  charset C2 if every character representable by C2 is also representable by C1.
 This means
...
/*!
 ...
 <p>Applications should generally create a <code>CharsetDecoder</code> using <code>newDecoder</code>
  for performance.
 @param buffer the byte buffer containing the content to be decoded.
...
/*!
 @brief Returns the system's default charset.This is determined during VM startup, and will not
  change thereafter.
...
/*!
 @brief Determines whether this charset equals to the given object.They are
...
/*!
 @brief Gets a string representation of this charset.Usually this contains the
...
/*!
 @brief Constructs a <code>Charset</code> object.Duplicated aliases are
  ignored.
