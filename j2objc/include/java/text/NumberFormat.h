...
/*!
 ...
 <code>java.lang.Number</code> for all integral type values that
  can be converted to <code>long</code> without loss of information,
  including <code>BigInteger</code> values with a 
 <code>length</code> of less than 64,
  and <code>java.lang.Number</code> for all other types. It
  then calls 
 ...
 */
+ (JavaTextNumberFormat *)getCurrencyInstanceWithJavaUtilLocale:(JavaUtilLocale *)inLocale;
 ...
 */
+ (JavaTextNumberFormat *)getInstanceWithJavaUtilLocale:(JavaUtilLocale *)inLocale;
...
/*!
 ...
 @since 1.4
 */
+ (JavaTextNumberFormat *)getIntegerInstanceWithJavaUtilLocale:(JavaUtilLocale *)inLocale;
...
/*!
 @brief Returns a general-purpose number format for the specified locale.
 */
+ (JavaTextNumberFormat *)getNumberInstanceWithJavaUtilLocale:(JavaUtilLocale *)inLocale;
 ...
 */
+ (JavaTextNumberFormat *)getPercentInstanceWithJavaUtilLocale:(JavaUtilLocale *)inLocale;
...
/*!
 ...
 <p>
  See the <code>ParsePosition)</code> method for more information
  on number parsing.
