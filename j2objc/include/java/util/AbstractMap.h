...
/*!
 @brief <p>This implementation calls <tt>entrySet().clear()</tt>.
...
/*!
 @brief <p>This implementation iterates over <tt>entrySet()</tt> searching
...
/*!
 @brief <p>This implementation returns a set that subclasses <code>AbstractSet</code>.
...
/*!
 @brief <p>This implementation iterates over the specified map's 
...
/*!
 @brief <p>This implementation iterates over <tt>entrySet()</tt> searching for an
...
/*!
 @brief <p>This implementation returns <tt>entrySet().size()</tt>.
 */
- (jint)size;
...
/*!
 @brief <p>This implementation returns a collection that subclasses <code>AbstractCollection</code>
 .
