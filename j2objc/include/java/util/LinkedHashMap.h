...
/*!
 @brief This override alters behavior of superclass put method.It causes newly
...
/*!
 @brief Transfers all entries to new table array.This method is called
  by superclass resize.
 It is overridden for performance, as it is
