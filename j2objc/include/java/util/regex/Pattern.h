...
/*!
 ...
 <p> A regular expression, specified as a string, must first be compiled into
  ...
  a <code>Matcher</code> object that can match arbitrary <code>sequences<code></code>
  against the regular
...
/*!
 ...
 @since 1.8
 */
- (id<JavaUtilFunctionPredicate>)asPredicate;
 ...
 */
+ (JavaUtilRegexPattern *)compileWithNSString:(NSString *)regex;
...
/*!
 ...
 @since 1.8
 */
- (id<JavaUtilStreamStream>)splitAsStreamWithJavaLangCharSequence:(id<JavaLangCharSequence>)input;
