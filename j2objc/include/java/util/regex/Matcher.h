...
/*!
 @brief An engine that performs match operations on a <code>sequence<code></code>
 ...
 */
- (JavaUtilRegexMatcher *)appendReplacementWithJavaLangStringBuffer:(JavaLangStringBuffer *)sb
 ...
 */
- (JavaLangStringBuffer *)appendTailWithJavaLangStringBuffer:(JavaLangStringBuffer *)sb;
...
/*!
 ...
 @since 1.7
 */
- (NSString *)groupWithNSString:(NSString *)name;
...
/*!
 ...
 - seealso: java.util.regex.Matcher
 @since 1.5
 */
...
/*!
 ...
 @since 1.5
 */
- (JavaUtilRegexMatcher *)usePatternWithJavaUtilRegexPattern:(JavaUtilRegexPattern *)newPattern;
