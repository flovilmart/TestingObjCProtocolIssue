...
/*!
 ...
 - seealso: <a href="{@@docRoot}openjdk-redirect.html?v=8&path=/technotes/guides/extensions/spec.html#bundled">
...
/*!
 @brief <code>Name</code> object for <code>Sealed</code> manifest attribute
  used for sealing.
 - seealso: <a href="{@@docRoot}openjdk-redirect.html?v=8&path=/technotes/guides/extensions/spec.html#sealing">
       Extension Sealing</a>
 */
...
/*!
 @brief <code>Name</code> object for <code>Implementation-Vendor-URL</code>
  manifest attribute used for package versioning.
 - seealso: <a href="{@@docRoot}openjdk-redirect.html?v=8&path=/technotes/guides/versioning/spec/versioning2.html#wp90779">
       Java Product Versioning Specification</a>
 */
