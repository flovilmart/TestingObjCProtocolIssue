...
@endcode</blockquote>
 ...
 <li> <b>Date/Time</b> - may be applied to Java types which are capable of
  encoding a date or time: <code>long</code>, <code>Long</code>, <code>Calendar</code>, and 
 <code>Date</code>.
...
@endcode
 ...
 <tr><td valign="top"><code>'p'</code>
      <td> Locale-specific or afternoon
  marker
 ...
 <tr><td valign="top"><code>'A'</code>
      <td> Locale-specific full name of the of the week
 ,
      e.g. <code>"Sunday"</code>, <code>"Monday"</code>
  
 <tr><td valign="top"><code>'a'</code>
      <td> Locale-specific short name of the of the week
 ,
 ...
 <tr><td> ',' <td align="center" valign="top"> -
      ...
      <td align="center" valign="top"> -
      <td> The result will include locale-specific separators
 ...
 <p> For the floating-point conversions <code>'e'</code>, <code>'E'</code>, and 
...
@endcode
 ...
 <li> If a decimal separator is present, a locale-specific separator
  is
  substituted. 
 <li> If the <code>','</code> (<tt>'&#92;u002c'</tt>)
  <a name="l10n group">flag</a> is given, then the locale-specific separator
  is
 ...
 <li> If the <code>'0'</code> flag is given, then the locale-specific digits
  are inserted
 ...
 <tr><td valign="top"> <code>'d'</code>
      ...
      <td> Formats the argument as a decimal integer. The <a href="#l10n algorithm">
 ...
 <p> If <code>'('</code>, <code>'+'</code>, '&nbsp&nbsp;', or <code>','</code> flags
 ...
 <tr><td valign="top"> <code>'X'</code>
      ...
      representing the number will be converted to case
 ...
 <tr><td valign="top"> <code>','</code>
      ...
      <td> Requires the output to include the locale-specific separators
  as
 ...
 <tr><td valign="top"> <code>'d'</code>
      <td valign="top"> <tt>'&#92;u0054'</tt>
      <td> Requires the output to be formatted as a decimal integer. The <a href="#l10n algorithm">
 localization algorithm</a> is applied.
 ...
 computerized scientific notation</a>.  The <a href="#l10n algorithm">
 localization algorithm</a> is applied.
 ...
 <p> Let <i>n</i> be the unique integer such that 10<sup><i>n</i></sup>
      ...
      part of <i>a</i>, followed by the lower-case locale-specific separator
      (e.g. <code>'e'</code>), followed by the sign of the exponent, followed
      by a representation of <i>n</i> as a decimal integer, as produced by the
      method <code>int)</code>, and zero-padded to include at
      least two digits.     
 ...
 <tr><td valign="top"> <code>'E'</code>
      ...
      will be the upper-case locale-specific separator
      (e.g. <code>'E'</code>).
...
/*!
 ...
 <p> The locale used is the locale
...
/*!
 ...
 <p> The charset used is the charset
  for this
  instance of the Java virtual machine. 
 <p> The locale used is the locale
  for this instance of the Java virtual machine.
