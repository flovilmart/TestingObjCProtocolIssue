...
/*!
 ...
 <code>float</code> value, chosen (approximately) uniformly from the
  ...
  pseudorandomly generated and returned. All 2<font size="-1">
 <sup>24</sup></font> possible <code>float</code> values
  of the form <i>m&nbsp;x&nbsp</i>2<font size="-1">
 <sup>-24</sup></font>, where <i>m</i> is a positive
...
/*!
 @brief Returns the next pseudorandom, uniformly distributed <code>int</code>
  ...
  pseudorandomly generated and returned.
 All 2<font size="-1"><sup>32
  </sup></font> possible <code>int</code> values are produced with
  (approximately) equal probability. 
...
@endcode
 ...
 @throw IllegalArgumentExceptionif n is not positive
 @since 1.2
 */
