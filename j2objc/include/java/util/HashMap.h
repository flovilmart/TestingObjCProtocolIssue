...
/*!
 @brief Initialization hook for subclasses.This method is called
  in all constructors and pseudo-constructors (clone, readObject)
  after HashMap has been initialized but before any entries have
  been inserted.
 (In the absence of this method, readObject would
 ...
 */
inline IOSObjectArray *JavaUtilHashMap_get_EMPTY_TABLE(void);
 ...
 */
inline jfloat JavaUtilHashMap_get_loadFactor_(void);
