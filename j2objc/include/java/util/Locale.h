...
/*!
 ...
 <blockquote>
  @code
      ...
      <code>language)</code>
      <code>language, String country)</code>
      <code>language, String country, String variant)</code>
...
<p>If the specified language tag contains any ill-formed subtags,
  ...
  to <code>Locale.Builder</code> which throws an exception
  in this case. 
...
- seealso: java.util.Locale.Builder
@since 1.7
 */
...
/*!
 ...
 @since 1.7
 */
+ (JavaUtilLocale *)getDefaultWithJavaUtilLocale_Category:(JavaUtilLocale_Category *)category;
