...
<blockquote>
  getDisplayName(false, <code>LONG</code>,
                 Locale.getDefault(<code>Locale.Category</code>))
   </blockquote>
@endcode
...
@endcode
 ...
 - seealso: Locale#getDefault(Locale.Category)
 - seealso: Locale.Category
 - seealso: java.text.DateFormatSymbols
 */
...
/*!
 ...
 @param offset an array of int where the raw GMT offset  (offset[0]) and daylight saving amount (offset[1]) are stored,
