...
@endcode</blockquote>
 ...
 <p> A scanner can read text from any object which implements the <code>java.lang.Readable</code>
  ...
  readable's <code>java.lang.Readable</code> method throws an <code>java.io.IOException</code>
 ...
 <a name="initial-locale">initial locale </a>is the value returned by the <code>java.util.Locale</code>
...
/*!
 ...
 <i>Integer</i></a> regular expression defined
  ...
  by removing all group separators, mapping non-ASCII digits into ASCII
  digits via the <code>Character.digit</code>, and passing the
  resulting string to the <code>int)</code>
