...
/*!
 @brief The <code>Calendar</code> class is an abstract class that provides methods
  for converting between a specific instant in time and a set of <code>fields</code>
...
@endcode</blockquote>
 ...
 <p><em>Example</em>: See <code>java.util.GregorianCalendar</code>.
...
/*!
 ...
 the resolution rule for the time of
  ...
  the hour of day value of this <code>Calendar</code>. Use <code>0)</code>
  to reset the hour
  value.
...
/*!
 ...
 <code>SHORT</code>
  , <code>LONG</code> , or <code>ALL_STYLES</code> .
...
/*!
 ...
 @return a Calendar.
 */
+ (JavaUtilCalendar *)getInstanceWithJavaUtilLocale:(JavaUtilLocale *)aLocale;
...
/*!
 ...
 @return a Calendar.
 */
+ (JavaUtilCalendar *)getInstanceWithJavaUtilTimeZone:(JavaUtilTimeZone *)zone;
...
/*!
 ...
 - seealso: #setInternallySetState(int)
 */
- (jint)selectFields;
