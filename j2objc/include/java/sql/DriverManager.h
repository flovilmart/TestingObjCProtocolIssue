...
FOUNDATION_EXPORT void JavaSqlDriverInfo_initWithJavaSqlDriver_(JavaSqlDriverInfo *self, id<JavaSqlDriver> driver);

FOUNDATION_EXPORT JavaSqlDriverInfo *new_JavaSqlDriverInfo_initWithJavaSqlDriver_(id<JavaSqlDriver> driver) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaSqlDriverInfo *create_JavaSqlDriverInfo_initWithJavaSqlDriver_(id<JavaSqlDriver> driver);
