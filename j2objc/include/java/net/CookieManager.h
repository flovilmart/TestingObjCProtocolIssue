...
/*!
 ...
 @param store a  <tt> CookieStore </tt>  to be used by cookie manager.                   if 
  <tt> null </tt> , cookie manager will use a default one,                   which is an in-memory CookieStore implmentation.
 @param cookiePolicy a  <tt> CookiePolicy </tt>  instance                           to be used by cookie manager as policy callback.
                            if 
...
/*!
 ...
 @param cookiePolicy the cookie policy. Can be  <tt> null </tt> , which                           has no effects on current cookie policy.
 */
