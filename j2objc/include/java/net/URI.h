...
/*!
 ...
 <tt>'&#92;uFFFD'</tt>, the Unicode replacement character.  </p></li>
  ...
  as follows: 
 <ul>
    <li><p> The <code>constructor</code></code>
  requires any illegal characters in its argument to be
    quoted and preserves any escaped octets and <i>other</i> characters that
    are present.  </p></li>
    <li><p> The <code>constructors</code></code>
...
/*!
 ...
 <li><p> IPv6 addresses are permitted for the host component.  An IPv6
    ...
    <tt>']'</tt>) as specified by <a href="http://www.ietf.org/rfc/rfc2732.txt">
 RFC&nbsp;2732</a>.  The
...
/*!
 ...
 <p> This convenience method works as if invoking it were equivalent to
  evaluating the expression <tt><code>resolve</code>
 (URI.<code>create</code>(str))</tt>. </p>
 @param str The string to be parsed into a URI
 @return The resulting URI
 @throw NullPointerException
 If <tt>str</tt> is <tt>null</tt>
