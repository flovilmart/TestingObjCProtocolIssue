...
FOUNDATION_EXPORT void JavaNetUnknownContentHandler_init(JavaNetUnknownContentHandler *self);

FOUNDATION_EXPORT JavaNetUnknownContentHandler *new_JavaNetUnknownContentHandler_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaNetUnknownContentHandler *create_JavaNetUnknownContentHandler_init(void);
