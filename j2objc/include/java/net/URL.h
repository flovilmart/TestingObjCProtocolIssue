...
@interface JavaNetURL : NSObject < JavaIoSerializable > {
 @public
  ...
  /*!
   @brief The URLStreamHandler for this URL.
   */
...
+ (void)setFactory:(id<JavaNetURLStreamHandlerFactory>)value;

+ (JavaUtilHashtable *)handlers;

+ (void)setHandlers:(JavaUtilHashtable *)value;
...
/*!
 @brief Sets an application's <code>URLStreamHandlerFactory</code>.
 ...
 @throw Errorif the application has already set a factory.
...
/*!
 @brief Returns the Stream Handler.
...
J2OBJC_FIELD_SETTER(JavaNetURL, hostAddress_, JavaNetInetAddress *)
J2OBJC_FIELD_SETTER(JavaNetURL, handler_, JavaNetURLStreamHandler *)
...
/*!
 @brief The URLStreamHandler factory.
 */
inline id<JavaNetURLStreamHandlerFactory> JavaNetURL_get_factory(void);
inline id<JavaNetURLStreamHandlerFactory> JavaNetURL_set_factory(id<JavaNetURLStreamHandlerFactory> value);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT id<JavaNetURLStreamHandlerFactory> JavaNetURL_factory;
J2OBJC_STATIC_FIELD_OBJ(JavaNetURL, factory, id<JavaNetURLStreamHandlerFactory>)

/*!
 @brief A table of protocol handlers.
 */
inline JavaUtilHashtable *JavaNetURL_get_handlers(void);
inline JavaUtilHashtable *JavaNetURL_set_handlers(JavaUtilHashtable *value);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT JavaUtilHashtable *JavaNetURL_handlers;
J2OBJC_STATIC_FIELD_OBJ(JavaNetURL, handlers, JavaUtilHashtable *)
...
FOUNDATION_EXPORT JavaNetURLStreamHandler *JavaNetURL_getURLStreamHandlerWithNSString_(NSString *protocol);
...
FOUNDATION_EXPORT void JavaNetParts_initWithNSString_withNSString_(JavaNetParts *self, NSString *file, NSString *host);

FOUNDATION_EXPORT JavaNetParts *new_JavaNetParts_initWithNSString_withNSString_(NSString *file, NSString *host) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaNetParts *create_JavaNetParts_initWithNSString_withNSString_(NSString *file, NSString *host);
