...
FOUNDATION_EXPORT JavaLangSystemClassLoader *new_JavaLangSystemClassLoader_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT JavaLangSystemClassLoader *create_JavaLangSystemClassLoader_init(void);
