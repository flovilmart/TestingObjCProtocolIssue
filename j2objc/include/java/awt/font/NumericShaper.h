...
@endcode</blockquote>
 ...
 <p>This class supports two different programming interfaces to
  ...
  enum-based ones, such as <code>NumericShaper.Range</code>.
...
@endcode</blockquote>
 ...
 <table border=1 cellspacing=3 cellpadding=0 summary="NumericShaper constants precedence.">
     ...
     <tr>
        <td><code>NumericShaper.Range</code><br>
            <code>NumericShaper.Range</code></td>
        <td><code>NumericShaper.Range</code></td>
     </tr>
     <tr>
        <td>Tai Tham</td>
        <td><code>NumericShaper.Range</code><br>
...
/*!
 @brief A <code>NumericShaper.Range</code> represents a Unicode range of a
  script having its own decimal digits.For example, the <code>NumericShaper.Range</code>
